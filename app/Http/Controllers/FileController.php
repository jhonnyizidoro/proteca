...
class FileController extends Controller
{
     ...
     * @param String uma string que represta o nome do campo em que o arquivo está, por default é file (usado pelo tinyMCE)
     * @return JSON retorn uma json com a lotation do arquivo ['location' => 'path']
     */
    public static function uploadFileFromRequest(Request $request, String $label = 'file')
    {
        $image = $request->$label;
        $name = FileController::sanitizeFileName($image->getClientOriginalName());
